...
<head>
    ...
    <title>ConfSays: ${requestScope.conference.title} </title>
...
<div id="wrapper">
    ...
    <div id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <shiro:authenticated>
                <li><a href="#stop-tracking"><i class="fa fa-stop"></i> Stop Tracking</a>
                </li>
            </shiro:authenticated>
        </ul>
    </div>
...
<script type="text/x-mustache-template" id="retweet-template">
    <div class="tweet">
        <h3> {{tweetedBy}} tweet retweeted {{retweetCount}} times</h3>
...
<script type="text/x-mustache-template" id="user-template">
    <div class="user">
        <h3><a href="//twitter.com/{{twitterHandle}}" target="_blank">{{twitterHandle}}</a> tweeted {{count}} times</h3>
    </div>
</script>

<script type="text/x-mustache-template" id="speaker-mention-template">
    <div class="speaker-mention">
        <h3><a href="//twitter.com/{{twitterHandle}}" target="_blank">{{twitterHandle}}</a> mentioned {{count}} times
        </h3>
    </div>
</script>
