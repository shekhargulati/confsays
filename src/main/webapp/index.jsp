...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6">
            <h2>ConfSays</h2>
            <small>Helps you learn what attendees were saying about the conference</small>

            <ul class="list-unstyled">
                <li><strong><i class="fa fa-retweet"></i> Most Retweeted</strong>

                    <p>learn which tweets were most retweeted
                    </p></li>
                <li><strong><i class="fa fa-user"></i> Active Attendees</strong>

                    <p>connect with the active users</p>
                </li>
                <li><strong><i class="fa fa-microphone"></i> Talked about Speakers</strong>

                    <p>learn which speakers were most talked about</p>
                </li>
                <li><strong><i class="fa fa-comments"></i> Talked about Attendees</strong>

                    <p>learn which attendees were most talked about</p>
                </li>
            </ul>
        </div>
        <div class="col-md-6">
            ...
            <form class="form-horizontal" id="signupForm" action="<c:url value="/signup"/>" method="post">
                ...
                <p>
                    <small>By clicking Sign Up, you agree to our Terms and that you have read our Data Use Policy,
    ...
    <div id="footer">
        <div class="container">
            <p class="text-muted credit">Made with &hearts; by <a href="https://twitter.com/shekhargulati/"
                                                                  target="_blank">Shekhar Gulati</a>.</p>
        </div>
    </div>
</div>
